...
void publishState() {
    ...
    stateJson["temperature"] = tempC;
    stateJson["pressurePa"] = pressurePascals;
...
void publishAutoConfig() {
    ...
    autoconfPayload["icon"] = "mdi:temperature";
    ...
    autoconfPayload["unit_of_measurement"] = "Pa";
    autoconfPayload["value_template"] = "{{value_json.pressurePa}}";
